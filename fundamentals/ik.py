...
class IkHandle(object):
    ...
    def check_ik_name(self, startJoint = None, endEffector = None, 
                       side = None, name = None, suffix = None):
        ######################################################################## 
    ...
    def ikSCsolver(self, startJoint = None, endEffector = None, 
                    side = None, name = None, suffix = None):
        ######################################################################## 
        #do the proper naming checks
        self.check_ik_name(startJoint = startJoint, endEffector = endEffector, 
                           side = side, name = name, suffix = suffix)

        #create the ik_handle
        ik = cmds.ik_handle(startJoint = startJoint, endEffector = endEffector, 
    ...
    def ikRPsolver(self, startJoint = None, endEffector = None, 
                    side = None, name = None, suffix = None):
        ######################################################################## 
        #do the proper naming checks
        self.check_ik_name(startJoint = startJoint, endEffector = endEffector, 
    ...
    def ikSplineSolver(self, startJoint = None, endEffector = None, 
                        curve = None, side = None, name = None, suffix = None):
        ######################################################################## 
        #do the proper naming checks
        self.check_ik_name(startJoint = startJoint, endEffector = endEffector, 
                           side = side, name = name, suffix = suffix)
        ...
        #create the ik_handle
        if curve == None:
            ik = cmds.ik_handle(startJoint = startJoint, 
